...
//   const pageUrlMap: Record<string, RegExp> = {
//     'My Profile': PageUrls.MY_PROFILE,
//     'Employee Directory': PageUrls.EMPLOYEE_DIRECTORY,
//   };

//   const expectedUrl = pageUrlMap[page];

//   if (!expectedUrl) {
//     throw new Error(`❌ No URL mapping found for Organization page: "${page}"`);
//   }
...
//       break;
//     default:
//       throw new Error(`❌ Unknown Leave & Attendance page: ${page}`);
//   }
// });
...
//   if (!expectedUrl) {
//     throw new Error(`❌ No URL mapping found for Leave & Attendance page: "${page}"`);
//   }
