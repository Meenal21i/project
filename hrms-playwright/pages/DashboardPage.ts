...
export class DashboardPage extends NavigationPage {
  ...
  // // Optional: Validate heading if dashboard has a known title/header element
  // async validateDashboardHeading(expectedHeading: string): Promise<void> {
  //   const heading = this.page.locator(NavBarLocators.Dashboard);
